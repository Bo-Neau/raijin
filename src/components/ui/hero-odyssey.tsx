...
/** Original Lightning component — colored output via HSV. Exported so other
 *  parts of the app can use the same shader. */
export const Lightning: React.FC<LightningProps> = ({
  ...
  useEffect(() => {
    ...
    const uSpeedU = gl.getUniformLocation(program, 'uSpeed')
